...
export const authLogs: IErrors<IAuthLogs> = {
    LOGIN_SUCCESS: {
        code: 0,
        message: 'User "{email} : {lastName} {firstName}" has logged in successfully.',
        type: "LOGIN_SUCCESS",
    },
    MOBILE_LOGIN_SUCCESS: {
        code: 1,
        message: 'User "{email} : {lastName} {firstName}" has logged in successfully from mobile.',
    ...
    AUTH_BACK: {
        code: 16,
        message: 'User "{email} : {{lastName} {firstName}" has logged back successfully.',
        type: "AUTH_BACK",
    },
    LOGOUT_SUCCESS: {
        code: 17,
        message: 'User "{email} : {lastName} {firstName}" has logged out successfully.',
        type: "LOGOUT_SUCCESS",
    },
    USER_NOT_FOUND: {
        code: 18,
    ...
    REGISTER_SUCCESS: {
        code: 26,
        message: 'User "{email} : {lastName} {firstName}" has registered successfully.',
