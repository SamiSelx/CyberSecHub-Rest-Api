...
/**
 * @description The domain name of the platform. If 'DOMAIN' is not set, it defaults to 'CyberSecHub.club'
 * @default "CyberSecHub.club"
 * 
 */
export const DOMAIN = CheckEnv("DOMAIN", "CyberSecHub.club");

/**
 * @description The URL of the backend. If 'BACK_URL' is not set, it defaults to 'http://localhost:PORT' in development mode and 'https://CyberSecHub.club' in production mode.
...
export const PROJECT_Name = CheckEnv("PROJECT_Name", "CyberSecHub Platform");
